...
- **Secondary:** Stop wrestling with bloated API tools. Bring your team together in real-time.
- **Punchy:** API collaboration without the cloud lock-in.
...
🔄 **Real-Time Collaboration** (powered by WebSockets, you can literally see your teammates typing).
...
## Asset Checklist
- [ ] High-res logo (1:1 aspect ratio, minimum 240x240)
- [ ] Product Video/GIF (Optional but highly recommended) showcasing the real-time websocket collaboration feature.
- [ ] 3-5 clean, annotated screenshots (Request Builder, Environments pane, History view).

## Launch Timing
- Aim for 12:01 AM PST to maximize visibility for the full 24-hour cycle.
